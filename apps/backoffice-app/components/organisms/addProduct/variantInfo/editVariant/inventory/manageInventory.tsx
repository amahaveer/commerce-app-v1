    ...
    return (
        <Box className="flex flex-col">
            <Box className="flex flex-col border-b pb-4">
                ...
                <Typography className="text-2xl mb-2 mt-2 font-medium">{translate("product.addInventory")}</Typography>
                ...
                >
                    <Box className="flex flex-col px-4">
                        <Box className="flex flex-col pl-8" gap={2}>
                            <CustomFieldMapper formFields={addInventoryForm} formData={{}} register={register} errors={errors} />
                        </Box>
